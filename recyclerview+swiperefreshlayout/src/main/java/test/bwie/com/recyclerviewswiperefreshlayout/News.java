...
public class News {
    ...
    public static class 美女Bean {
         ...
         * clkNum : 0
         * danmu : 1
         * digest : 我该怎样感谢你，赐我空欢喜。
         * docid : CPSCO2099001O20A
         * downTimes : 205
         * hasAD : 1
         * img : http://dmr.nosdn.127.net/61wrbR9YlMTFcZcH3zeOSQ==/6896093023032466299.jpg
         * imgType : 0
         * imgsrc : http://dmr.nosdn.127.net/61wrbR9YlMTFcZcH3zeOSQ==/6896093023032466299.jpg
         * imgsum : 0
         * picCount : 0
         * pixel : 700*472
         * program : HY
