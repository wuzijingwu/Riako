...
public class ReadInfo {
    ...
    public static class 美女Bean {
         ...
         * clkNum : 0
         * danmu : 1
         * digest : 海边唯美清新气质长发背影女生头像
         * docid : CS594CV390014CV4
         * downTimes : 81
         * hasAD : 1
         * img : http://dmr.nosdn.127.net/kh2DDq9sdlXmfno7_nrSFw==/6896093023065826991.jpg
         * imgType : 0
         * imgsrc : http://dmr.nosdn.127.net/kh2DDq9sdlXmfno7_nrSFw==/6896093023065826991.jpg
         * imgsum : 0
         * picCount : 0
         * pixel : 300*300
         * program : HY
         ...
         * refreshPrompt : 0
         * replyCount : 0
         * replyid : CS594CV390014CV4
         * source : 唯美图片
         * title : 海边唯美清新气质长发背影女生头像
         * upTimes : 100
         */
